...
if("TRUE" STREQUAL "TRUE")
  set(jetbot_pro_SOURCE_PREFIX /home/jetbot/catkin_ws/src/jetbot_pro)
  set(jetbot_pro_DEVEL_PREFIX /home/jetbot/catkin_ws/devel)
  ...
  set(jetbot_pro_INSTALL_PREFIX /home/jetbot/catkin_ws/install)
...
if(NOT "/home/jetbot/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'jetbot_pro' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jetbot/catkin_ws/src/jetbot_pro/${idir}'.  ${_report}")
    endif()
